...
@Component({
  ...
  template: `
    ...
    <section class="ai-rule"><span>✦</span><p>Planner chạy cục bộ, không gửi dữ liệu ra ngoài. <a routerLink="/app/calendar">Xem lịch</a> là source of truth duy nhất.</p></section>
  `,
})
export class AiPage {
